...
let UserResolver = class UserResolver {
    changePassword(token, newPassword, { redis, req }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            User_1.User.update({ id: parseInt(userId) }, { password: yield argon2_1.default.hash(newPassword) });
            redis.del(key);
    ...
    forgotPassword(email, { redis }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield redis.set(constants_1.FORGET_PASSWORD_PREFIX + token, user.id.toString(), "ex", 1000 * 60 * 60 * 24 * 3);
    ...
    register(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                user = yield User_1.User.findOne({ password: hashedPassword });
            }
            catch (err) {
                console.log(err);
